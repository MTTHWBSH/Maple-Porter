...
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/assets/js/plugins-ck.js"></script>
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/assets/js/main-ck.js"></script>
